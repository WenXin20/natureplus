...
public class BoneMealJarItem extends NatureplusModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(NaturePlusTabItemGroup.tab).maxDamage(9));
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7b\u00A7oSimilar to Bone Meal"));
			list.add(new StringTextComponent("\u00A7b\u00A7oRight-click a flower to grow a giant version"));
