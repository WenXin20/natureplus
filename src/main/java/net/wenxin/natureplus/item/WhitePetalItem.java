...
public class WhitePetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:white_petal")
	public static final Item block = null;
	public WhitePetalItem(NatureplusModElements instance) {
		super(instance, 81);
	}
