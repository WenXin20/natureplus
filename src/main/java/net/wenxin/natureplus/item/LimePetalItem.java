...
public class LimePetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:lime_petal")
	public static final Item block = null;
	public LimePetalItem(NatureplusModElements instance) {
		super(instance, 88);
	}
