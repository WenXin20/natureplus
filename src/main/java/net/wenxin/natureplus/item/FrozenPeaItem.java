...
public class FrozenPeaItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:frozen_pea")
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletfrozen_pea").setRegistryName("entitybulletfrozen_pea"));
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(FrozenPeaItem.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				FrozenPeaEffectsProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static ArrowCustomEntity shoot(World world, LivingEntity entity, Random random, float power, double damage, int knockback) {
		...
		world.playSound((PlayerEntity) null, (double) x, (double) y, (double) z,
				(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("natureplus:snow_pea_firing")),
