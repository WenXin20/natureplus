...
public class CyanPetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:cyan_petal")
	public static final Item block = null;
	public CyanPetalItem(NatureplusModElements instance) {
		super(instance, 94);
	}
