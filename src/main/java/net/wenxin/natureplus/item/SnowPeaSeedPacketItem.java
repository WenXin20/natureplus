...
import net.wenxin.natureplus.procedures.SnowPeaSpawnProcedure;
...
public class SnowPeaSeedPacketItem extends NatureplusModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("snow_pea_seed_packet");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				SnowPeaSpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
