...
import net.wenxin.natureplus.procedures.SunflowerSpawnProcedure;
...
public class SunflowerSeedPacketItem extends NatureplusModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("sunflower_seed_packet");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				SunflowerSpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
