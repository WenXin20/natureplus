...
public class MagentaPetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:magenta_petal")
	public static final Item block = null;
	public MagentaPetalItem(NatureplusModElements instance) {
		super(instance, 87);
	}
