...
public class DiamondButterflyNetItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:diamond_butterfly_net")
	public static final Item block = null;
	public DiamondButterflyNetItem(NatureplusModElements instance) {
		super(instance, 129);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("diamond_butterfly_net"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(NaturePlusTabItemGroup.tab).maxDamage(40));
		}
