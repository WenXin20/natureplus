...
public class StoneButterflyNetItem extends NatureplusModElements.ModElement {
	...
	public void initElements() {
		...
		}.setRegistryName("stone_butterfly_net"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(NaturePlusTabItemGroup.tab).maxDamage(10));
		}
