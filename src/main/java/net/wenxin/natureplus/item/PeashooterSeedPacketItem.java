...
import net.wenxin.natureplus.procedures.PeashooterSpawnProcedure;
...
public class PeashooterSeedPacketItem extends NatureplusModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("peashooter_seed_packet");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			ItemStack itemstack = context.getItem();
			{
				...
				PeashooterSpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
