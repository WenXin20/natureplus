...
public class MonarchEggItemItem extends NatureplusModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("monarch_egg_item");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7b\u00A7oSpawns a Monarch Caterpillar"));
		}
