...
public class IronButterflyNetItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:iron_butterfly_net")
	public static final Item block = null;
	public IronButterflyNetItem(NatureplusModElements instance) {
		super(instance, 121);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("iron_butterfly_net"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(NaturePlusTabItemGroup.tab).maxDamage(20));
		}
