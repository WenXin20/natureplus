...
public class YellowPetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:yellow_petal")
	public static final Item block = null;
	public YellowPetalItem(NatureplusModElements instance) {
		super(instance, 87);
	}
