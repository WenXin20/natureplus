...
public class BrownPetalItem extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:brown_petal")
	public static final Item block = null;
	public BrownPetalItem(NatureplusModElements instance) {
		super(instance, 97);
	}
