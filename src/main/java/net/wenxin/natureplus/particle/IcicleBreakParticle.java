...
public class IcicleBreakParticle extends NatureplusModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public IcicleBreakParticle(NatureplusModElements instance) {
		super(instance, 941);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("icicle_break"));
	}
