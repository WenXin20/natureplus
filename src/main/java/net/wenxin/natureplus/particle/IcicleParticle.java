...
public class IcicleParticle extends NatureplusModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public IcicleParticle(NatureplusModElements instance) {
		super(instance, 940);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("icicle"));
	}
