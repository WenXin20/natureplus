...
import net.wenxin.natureplus.item.LightBluePetalItem;
...
public class SpadeRemoveSnowPeaProcedure extends NatureplusModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure SpadeRemoveSnowPea!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			System.err.println("Failed to load dependency sourceentity for procedure SpadeRemoveSnowPea!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure SpadeRemoveSnowPea!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure SpadeRemoveSnowPea!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure SpadeRemoveSnowPea!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure SpadeRemoveSnowPea!");
			return;
		}
		...
		if ((!(world.getWorld().isRemote))) {
			if (((entity instanceof SnowPeaEntity.CustomEntity)
				...
				if ((Math.random() < 0.25)) {
					if (!world.getWorld().isRemote) {
						ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(FrozenPeaItem.block, (int) (1)));
				...
				if ((Math.random() < 0.25)) {
					if (!world.getWorld().isRemote) {
						ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(LightBluePetalItem.block, (int) (1)));
						entityToSpawn.setPickupDelay(10);
						world.addEntity(entityToSpawn);
					}
				}
			...
			} else if (((entity instanceof SnowPeaEntity.CustomEntity)
					&& ((ItemTags.getCollection().getOrCreate(new ResourceLocation(("forge:spade").toLowerCase(java.util.Locale.ENGLISH)))
