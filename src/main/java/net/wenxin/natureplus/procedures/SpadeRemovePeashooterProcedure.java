...
public class SpadeRemovePeashooterProcedure extends NatureplusModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((!(world.isRemote))) {
			if (((entity instanceof PeashooterEntity.CustomEntity)
				...
				if ((Math.random() < 0.25)) {
					if (!world.isRemote) {
						ItemEntity entityToSpawn = new ItemEntity(world, x, y, z, new ItemStack(PeaItem.block, (int) (1)));
				...
				if ((Math.random() < 0.25)) {
					if (!world.isRemote) {
						ItemEntity entityToSpawn = new ItemEntity(world, x, y, z, new ItemStack(GreenPetalItem.block, (int) (1)));
						entityToSpawn.setPickupDelay(10);
						world.addEntity(entityToSpawn);
					}
				}
