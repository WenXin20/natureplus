...
public class SpawnLightGrayBalloonProcedure extends NatureplusModElements.ModElement {
	public SpawnLightGrayBalloonProcedure(NatureplusModElements instance) {
		super(instance, 721);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((!(world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z)).isSolid()))
				&& (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
						.getItem() == new ItemStack(LightGrayBalloonItemItem.block, (int) (1)).getItem()))) {
			if (world instanceof World && !world.getWorld().isRemote) {
				Entity entityToSpawn = new LightGrayBalloonEntity.CustomEntity(LightGrayBalloonEntity.entity, world.getWorld());
