	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((world.canBlockSeeSky(new BlockPos((int) x, (int) y, (int) z)))
				&& ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
						...
						&& (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == MexicanSunflowerBlock.block
				...
				&& ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
						...
						&& (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == MexicanSunflowerBlock.block
								...
								&& ((((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY))
										.getDamage()) <= 18) && (!(entity.isSneaking()))))))) {
			if (entity instanceof PlayerEntity && !entity.world.isRemote) {
				((PlayerEntity) entity).sendStatusMessage(new StringTextComponent("Mexican Sunflowers can't be grown beneath other blocks"), (true));
			}
		}
	}
