...
import net.wenxin.natureplus.procedures.RemoveUndyedBalloonProcedure;
...
public class UndyedBalloonEntity extends NatureplusModElements.ModElement {
	public static EntityType entity = null;
	public UndyedBalloonEntity(NatureplusModElements instance) {
		super(instance, 151);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 2.3f)).build("undyed_balloon")
						.setRegistryName("undyed_balloon");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBalloon(), 0.3f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/undyed_balloon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RemoveUndyedBalloonProcedure.executeProcedure($_dependencies);
			}
