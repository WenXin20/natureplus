...
import net.wenxin.natureplus.procedures.RemoveBrownBalloonProcedure;
...
public class BrownBalloonEntity extends NatureplusModElements.ModElement {
	public static EntityType entity = null;
	public BrownBalloonEntity(NatureplusModElements instance) {
		super(instance, 170);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 2.3f)).build("brown_balloon")
						.setRegistryName("brown_balloon");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBalloon(), 0.3f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/brown_balloon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RemoveBrownBalloonProcedure.executeProcedure($_dependencies);
			}
