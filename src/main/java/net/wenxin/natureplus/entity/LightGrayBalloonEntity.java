...
import net.wenxin.natureplus.procedures.RemoveLightGrayBalloonProcedure;
...
public class LightGrayBalloonEntity extends NatureplusModElements.ModElement {
	public static EntityType entity = null;
	public LightGrayBalloonEntity(NatureplusModElements instance) {
		super(instance, 152);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 2.3f)).build("light_gray_balloon")
						.setRegistryName("light_gray_balloon");
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBalloon(), 0.3f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/light_gray_balloon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("natureplus:balloon_rub"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("natureplus:balloon_pop"));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RemoveLightGrayBalloonProcedure.executeProcedure($_dependencies);
			}
		...
		public void onDeath(DamageSource source) {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				BalloonParticlesOnDeathProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				$_dependencies.put("entity", entity);
				$_dependencies.put("world", world);
				BalloonUpwardsMovementProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class ModelBalloon extends EntityModel<Entity> {
		...
		public void setRotationAngles(Entity e, float f, float f1, float f2, float f3, float f4) {
			this.main.rotationPointY = 24.5F + -(MathHelper.cos(f2 * 0.4F) * (float) Math.PI * 0.05F);
		}
	}
}
