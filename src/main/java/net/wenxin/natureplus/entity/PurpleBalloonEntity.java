...
import net.wenxin.natureplus.procedures.RemovePurpleBalloonProcedure;
...
public class PurpleBalloonEntity extends NatureplusModElements.ModElement {
	public static EntityType entity = null;
	public PurpleBalloonEntity(NatureplusModElements instance) {
		super(instance, 162);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 2.3f)).build("purple_balloon")
						.setRegistryName("purple_balloon");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBalloon(), 0.3f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/purple_balloon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RemovePurpleBalloonProcedure.executeProcedure($_dependencies);
			}
