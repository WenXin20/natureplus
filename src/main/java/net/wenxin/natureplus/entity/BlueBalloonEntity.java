...
import net.wenxin.natureplus.procedures.RemoveBlueBalloonProcedure;
...
public class BlueBalloonEntity extends NatureplusModElements.ModElement {
	public static EntityType entity = null;
	public BlueBalloonEntity(NatureplusModElements instance) {
		super(instance, 169);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.5f, 2.3f)).build("blue_balloon")
						.setRegistryName("blue_balloon");
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelBalloon(), 0.3f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/blue_balloon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				RemoveBlueBalloonProcedure.executeProcedure($_dependencies);
			}
