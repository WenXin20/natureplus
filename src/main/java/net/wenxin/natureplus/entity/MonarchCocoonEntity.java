...
import net.wenxin.natureplus.procedures.MonarchButterflySpawnProcedure;
...
public class MonarchCocoonEntity extends NatureplusModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.2f, 0.4f)).build("monarch_cocoon")
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			return new MobRenderer(renderManager, new ModelButterflyCocoon(), 0.2f) {
				@Override
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("natureplus:textures/monarch_cocoon.png");
				}
			};
		});
	}
	public static class CustomEntity extends CreatureEntity {
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				MonarchButterflySpawnProcedure.executeProcedure($_dependencies);
			}
		}
