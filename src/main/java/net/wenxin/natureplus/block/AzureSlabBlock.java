...
public class AzureSlabBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:azure_slab")
	public static final Block block = null;
	public AzureSlabBlock(NatureplusModElements instance) {
		super(instance, 14);
	}
