...
public class LightBluePetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:light_blue_petal_block")
	public static final Block block = null;
	public LightBluePetalBlockBlock(NatureplusModElements instance) {
		super(instance, 49);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("light_blue_petal_block");
		}
