...
public class AzureFenceGateBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:azure_fence_gate")
	public static final Block block = null;
	public AzureFenceGateBlock(NatureplusModElements instance) {
		super(instance, 800);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("azure_fence_gate");
		}
