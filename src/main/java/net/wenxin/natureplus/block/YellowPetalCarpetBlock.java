...
public class YellowPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:yellow_petal_carpet")
	public static final Block block = null;
	public YellowPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_petal_carpet");
		}
