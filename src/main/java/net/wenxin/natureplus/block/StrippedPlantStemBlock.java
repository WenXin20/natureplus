...
public class StrippedPlantStemBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:stripped_plant_stem")
	public static final Block block = null;
	public StrippedPlantStemBlock(NatureplusModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_plant_stem");
		}
