...
public class PinkPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:pink_petal_carpet")
	public static final Block block = null;
	public PinkPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 70);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_petal_carpet");
		}
