...
public class GrayPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:gray_petal_carpet")
	public static final Block block = null;
	public GrayPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("gray_petal_carpet");
		}
