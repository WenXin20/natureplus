...
public class CyanPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:cyan_petal_carpet")
	public static final Block block = null;
	public CyanPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_petal_carpet");
		}
