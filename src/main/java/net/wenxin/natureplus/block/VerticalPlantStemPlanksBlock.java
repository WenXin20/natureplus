...
public class VerticalPlantStemPlanksBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:vertical_plant_stem_planks")
	public static final Block block = null;
	public VerticalPlantStemPlanksBlock(NatureplusModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("vertical_plant_stem_planks");
		}
