...
public class PollenJarBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:pollen_jar")
	public static final Block block = null;
	public PollenJarBlock(NatureplusModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(PollenJarBlock.block, (int) (1));
		}
