...
public class WhitePetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:white_petal_block")
	public static final Block block = null;
	public WhitePetalBlockBlock(NatureplusModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("white_petal_block");
		}
