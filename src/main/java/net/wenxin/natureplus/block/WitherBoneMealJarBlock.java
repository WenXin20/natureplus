...
public class WitherBoneMealJarBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:wither_bone_meal_jar")
	public static final Block block = null;
	public WitherBoneMealJarBlock(NatureplusModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(WitherBoneMealJarBlock.block, (int) (1));
		}
