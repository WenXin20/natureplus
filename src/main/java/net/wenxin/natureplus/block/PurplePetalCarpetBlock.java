...
public class PurplePetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:purple_petal_carpet")
	public static final Block block = null;
	public PurplePetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_petal_carpet");
		}
