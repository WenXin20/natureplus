...
public class ThornsFlowerPotBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:potted_thorn")
	public static final Block block = null;
	public ThornsFlowerPotBlock(NatureplusModElements instance) {
		super(instance, 225);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				ThornsFlowerPotRightClickProcedure.executeProcedure($_dependencies);
			}
