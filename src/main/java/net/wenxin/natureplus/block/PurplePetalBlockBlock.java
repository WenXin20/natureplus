...
public class PurplePetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:purple_petal_block")
	public static final Block block = null;
	public PurplePetalBlockBlock(NatureplusModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_petal_block");
		}
