...
public class BluePetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:blue_petal_block")
	public static final Block block = null;
	public BluePetalBlockBlock(NatureplusModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_petal_block");
		}
