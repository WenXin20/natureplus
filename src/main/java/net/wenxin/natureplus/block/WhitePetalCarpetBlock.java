...
public class WhitePetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:white_petal_carpet")
	public static final Block block = null;
	public WhitePetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("white_petal_carpet");
		}
