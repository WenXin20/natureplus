...
public class GreenPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:green_petal_block")
	public static final Block block = null;
	public GreenPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 61);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("green_petal_block");
		}
