...
public class OrangePetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:orange_petal_carpet")
	public static final Block block = null;
	public OrangePetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_petal_carpet");
		}
