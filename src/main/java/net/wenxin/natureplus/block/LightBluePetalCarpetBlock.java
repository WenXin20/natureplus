...
public class LightBluePetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:light_blue_petal_carpet")
	public static final Block block = null;
	public LightBluePetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 67);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("light_blue_petal_carpet");
		}
