...
public class StrippedPlantStemWoodBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:stripped_plant_stem_wood")
	public static final Block block = null;
	public StrippedPlantStemWoodBlock(NatureplusModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stripped_plant_stem_wood");
		}
