...
import net.wenxin.natureplus.procedures.BluebonnetNaturalSpawnProcedure;
...
public class BluebonnetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:bluebonnet")
	public static final Block block = null;
	public BluebonnetBlock(NatureplusModElements instance) {
		super(instance, 104);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				if (!BluebonnetNaturalSpawnProcedure.executeProcedure(ImmutableMap.of("x", x, "y", y, "z", z, "world", world)))
					return false;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS, MaterialColor.LIGHT_BLUE).doesNotBlockMovement()
					.sound(SoundType.PLANT).hardnessAndResistance(0f, 1f).lightValue(0));
			setRegistryName("bluebonnet");
		}
