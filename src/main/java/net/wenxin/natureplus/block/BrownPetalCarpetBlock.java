...
public class BrownPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:brown_petal_carpet")
	public static final Block block = null;
	public BrownPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_petal_carpet");
		}
