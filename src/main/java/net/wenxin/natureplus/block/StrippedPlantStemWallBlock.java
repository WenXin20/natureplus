...
public class StrippedPlantStemWallBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:stripped_plant_stem_wall")
	public static final Block block = null;
	public StrippedPlantStemWallBlock(NatureplusModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_plant_stem_wall");
		}
