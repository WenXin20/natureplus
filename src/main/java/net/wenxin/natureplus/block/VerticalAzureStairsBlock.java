...
public class VerticalAzureStairsBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:vertical_azure_stairs")
	public static final Block block = null;
	public VerticalAzureStairsBlock(NatureplusModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("vertical_azure_stairs");
		}
