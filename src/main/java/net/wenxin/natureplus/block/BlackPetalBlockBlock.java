...
public class BlackPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:black_petal_block")
	public static final Block block = null;
	public BlackPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("black_petal_block");
		}
