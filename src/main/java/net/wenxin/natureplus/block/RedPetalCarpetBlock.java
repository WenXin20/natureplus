...
public class RedPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:red_petal_carpet")
	public static final Block block = null;
	public RedPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 80);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("red_petal_carpet");
		}
