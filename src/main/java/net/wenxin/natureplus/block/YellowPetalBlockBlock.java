...
public class YellowPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:yellow_petal_block")
	public static final Block block = null;
	public YellowPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_petal_block");
		}
