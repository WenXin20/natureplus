...
public class LimePetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:lime_petal_carpet")
	public static final Block block = null;
	public LimePetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 71);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("lime_petal_carpet");
		}
