...
public class LightGrayPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:light_gray_petal_carpet")
	public static final Block block = null;
	public LightGrayPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("light_gray_petal_carpet");
		}
