...
import net.wenxin.natureplus.procedures.PlantVaseRandomOutputRedstoneProcedure;
import net.wenxin.natureplus.procedures.PlantVaseRandomOutputProcedure;
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PlantVaseRandomOutputProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
