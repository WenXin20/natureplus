...
public class GrayPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:gray_petal_block")
	public static final Block block = null;
	public GrayPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("gray_petal_block");
		}
