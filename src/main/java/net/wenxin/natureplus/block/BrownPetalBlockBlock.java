...
public class BrownPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:brown_petal_block")
	public static final Block block = null;
	public BrownPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 60);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_petal_block");
		}
