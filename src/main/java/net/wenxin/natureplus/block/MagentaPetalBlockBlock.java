...
public class MagentaPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:magenta_petal_block")
	public static final Block block = null;
	public MagentaPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("magenta_petal_block");
		}
