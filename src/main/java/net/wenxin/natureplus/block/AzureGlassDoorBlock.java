...
public class AzureGlassDoorBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:azure_glass_door")
	public static final Block block = null;
	public AzureGlassDoorBlock(NatureplusModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("azure_glass_door");
		}
