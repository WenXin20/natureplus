...
public class CyanPetalBlockBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:cyan_petal_block")
	public static final Block block = null;
	public CyanPetalBlockBlock(NatureplusModElements instance) {
		super(instance, 57);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_petal_block");
		}
