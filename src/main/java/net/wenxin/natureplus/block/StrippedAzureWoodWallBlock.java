...
public class StrippedAzureWoodWallBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:stripped_azure_wood_wall")
	public static final Block block = null;
	public StrippedAzureWoodWallBlock(NatureplusModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_azure_wood_wall");
		}
