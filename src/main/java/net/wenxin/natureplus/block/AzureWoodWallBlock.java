...
public class AzureWoodWallBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:azure_wood_wall")
	public static final Block block = null;
	public AzureWoodWallBlock(NatureplusModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("azure_wood_wall");
		}
