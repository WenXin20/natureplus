...
public class GreenPetalCarpetBlock extends NatureplusModElements.ModElement {
	@ObjectHolder("natureplus:green_petal_carpet")
	public static final Block block = null;
	public GreenPetalCarpetBlock(NatureplusModElements instance) {
		super(instance, 79);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("green_petal_carpet");
		}
