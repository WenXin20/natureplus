...
public class AzureForestBiome extends NatureplusModElements.ModElement {
	...
	static class CustomBiome extends Biome {
		public CustomBiome() {
			...
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(MonarchCaterpillarEntity.entity, 8, 1, 4));
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(MonarchButterflyEntity.entity, 8, 1, 3));
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(MonarchEggEntity.entity, 8, 1, 3));
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(EntityType.BEE, 5, 1, 4));
			...
			this.addSpawn(EntityClassification.CREATURE, new Biome.SpawnListEntry(EntityType.SHEEP, 8, 1, 4));
