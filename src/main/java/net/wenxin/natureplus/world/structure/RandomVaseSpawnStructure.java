...
public class RandomVaseSpawnStructure extends NatureplusModElements.ModElement {
	public RandomVaseSpawnStructure(NatureplusModElements instance) {
		super(instance, 652);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 8000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("natureplus", "random_vase1"));
						if (template == null)
							return false;
